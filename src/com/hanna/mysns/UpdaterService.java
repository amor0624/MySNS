...
public class UpdaterService extends IntentService {
	...
	static final String NEW_STATUS_INTENT = "com.hanna.mysns.NEW_STATUS";
	static final String NEW_STATUS_EXTRA_COUNT = "NEW_STATUS_EXTRA_COUNT";
	public static final String RECEIVE_TIMELINE_NOTIFICATIONS = "com.hanna.mysns.RECEIVE_TIMELINE_NOTIFICATIONS";
	...
	protected void onHandleIntent(Intent inIntent) {
		...
		MySNSApplication yamba = (MySNSApplication) getApplication();
